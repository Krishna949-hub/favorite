...
const createCardElement = (cardData) => {
  cardData.forEach((data) => {
    ...
    cardElement.innerHTML = `
            ...
            <a href = "${data.spoonacularSourceUrl}"> Get Recipe</a>

            <button type = "button" id = "favorite"> Add to favorites </a>
...
const btnclick = document.getElementById("favorite");
var favItems = [];
...
/*
var favItems = [];
var favItemsFromLS = localStorage.getItem("favItems");
if(favItemsFromLS){
    favItems = JSON.parse(favItemsFromLS);
}
favItems.add(item);
